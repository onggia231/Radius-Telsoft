 ...
 */
package com.telsoft.packet;

import com.telsoft.OperationCodes.HeartBeat;
import com.telsoft.OperationCodes.IPAccessContextRequest;
import com.telsoft.OperationCodes.IPAccessContextResponse;
import com.telsoft.OperationCodes.NewIPAccessContext;
import com.telsoft.OperationCodes.NewIPAccessContextAck;
import com.telsoft.OperationCodes.ReleaseIPAccessContext;
import com.telsoft.OperationCodes.ReleaseIPAccessContextAck;
import com.telsoft.util.RadiusException;
import com.telsoft.util.RadiusUtil;
...
import com.telsoft.attribute.RadiusAttribute;
import com.telsoft.attribute.VendorSpecificAttribute;
import com.telsoft.dictionary.AttributeType;
...
//	public static final int STATUS_REJECT = 48;
	...
	public static final int NEW_IP_ACCESS_CONTEXT = 8;
	public static final int NEW_IP_ACCESS_CONTEXT_ACK = 9;
	public static final int  RELEASE_IP_ACCESS_CONTEXT = 10;
	public static final int RELEASE_IP_ACCESS_CONTEXT_ACK = 11;
	public static final int  IP_ACCESS_CONTEXT_REQUEST = 12;
	public static final int  IP_ACCESS_CONTEXT_RESPONSE = 13;
	public static final int MESSAGE_RESPONSE = 51;
...
//				return "Status-Reject";
			...
			case HEART_BEAT:
				return "Heart-Beat";
			case NEW_IP_ACCESS_CONTEXT:
				return "New-IP-Access-Context";
			case NEW_IP_ACCESS_CONTEXT_ACK:
				return "New-IP-Access-Context-Ack";
			case RELEASE_IP_ACCESS_CONTEXT:
				return "Release-IP-Access-Context";
			case RELEASE_IP_ACCESS_CONTEXT_ACK:
				return "Release-IP-Access-Context-Ack";
			case IP_ACCESS_CONTEXT_REQUEST:
				return "IP-Access-Context-Request";
			case IP_ACCESS_CONTEXT_RESPONSE:
				return "IP-Access-Context-Response";
...
//			case ACCOUNTING_RESPONSE:
			...
			case HEART_BEAT:
				...
				break;
			case NEW_IP_ACCESS_CONTEXT:
				rp = new NewIPAccessContext();
				break;
			case NEW_IP_ACCESS_CONTEXT_ACK:
				rp = new NewIPAccessContextAck();
				break;
			case RELEASE_IP_ACCESS_CONTEXT:
				rp = new ReleaseIPAccessContext();
				break;
			case RELEASE_IP_ACCESS_CONTEXT_ACK:
				rp = new ReleaseIPAccessContextAck();
				break;
			case IP_ACCESS_CONTEXT_REQUEST:
				rp = new IPAccessContextRequest();
				break;
			case IP_ACCESS_CONTEXT_RESPONSE:
				rp = new IPAccessContextResponse();
				break;
			case MESSAGE_RESPONSE:
			default:
				rp = new RadiusPacket();
	 ...
	 */
	// request (Cái này set title khi gửi đi)
