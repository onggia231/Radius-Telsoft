...
public class RadiusAttribute {
	 ...
	 * @return attribute
	 */
	// Khi client truyền đi nó sẽ dùng DatagramPacket mã hoá đóng gói thông tin lại
	 ...
	 */
	// Khi server nhận được DatagramPacket nó sẽ giải mã thông tin
