 ...
 */
package com.telsoft.dictionary;
...
public class MemoryDictionary implements WritableDictionary {
	...
	public AttributeType getAttributeTypeByCode(int vendorCode, int typeCode) {
		Map vendorAttributes = (Map) attributesByCode.get(Integer.valueOf(vendorCode));
		if (vendorAttributes == null) {
			return null;
		}
		return (AttributeType) vendorAttributes.get(Integer.valueOf(typeCode));
	}
	...
	public String getVendorName(int vendorId) {
		return (String) vendorsByCode.get(Integer.valueOf(vendorId));
	}
	...
	public void addVendor(int vendorId, String vendorName) {
		...
		vendorsByCode.put(Integer.valueOf(vendorId), vendorName);
	}
